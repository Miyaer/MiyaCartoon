...
-(void)createPageControl
{
    ...
    _pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:0.53 green:0.83 blue:0.94 alpha:1.00];//当前显示页的页码颜色
    _pageControl.pageIndicatorTintColor = [UIColor whiteColor];//普通模式的页码颜色

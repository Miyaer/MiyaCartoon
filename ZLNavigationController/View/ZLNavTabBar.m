...
- (void)showLineWithButtonWidth:(CGFloat)width
{
  ...
  //  _line.backgroundColor = UIColorWithRGBA(20.0f, 80.0f, 200.0f, 0.7f);
    _line.backgroundColor = [UIColor colorWithRed:0.45 green:0.79 blue:0.93 alpha:1.00];
...
- (NSArray *)getButtonsWidthWithTitles:(NSArray *)titles;
{
    ...
    for (NSString *title in titles)
    {
        ...
        NSNumber *width = [NSNumber numberWithFloat:size.width + 20.f+20];
...
- (CGFloat)contentWidthAndAddNavTabBarItemsWithButtonsWidth:(NSArray *)widths
{
    ...
    for (NSInteger index = 0; index < _selectedItemTitles.count; index++)
    {
        ...
        button.titleLabel.font = TABBAR_TITLE_SIZE_FONT;
